...
public class QuickSort implements Sorter {
    ...
    public enum RecursionEnd {
        ...
        AT_MOST_ONE() {
            @Override
            boolean end(final DataModel model, final int start, final int end, final int depth)
        ...
        /**
         * Sorts using Heap Sort when depth reaches a certain value, as used in
         * <a href="http://www.cs.rpi.edu/~musser/gp/introsort.ps">David Musser's IntroSort</a>.
         */
        MAX_LOG_DEPTH() {
            @Override
            boolean end(final DataModel model, final int start, final int end, final int depth)
         ...
         */
        abstract boolean end(DataModel model, int start, int end, int depth) throws InterruptedException;
    }
     ...
     * @throws InterruptedException if the sorting thread was interrupted
     */
    final boolean end(final DataModel model, final int start, final int end, final int depth)
            throws InterruptedException {
